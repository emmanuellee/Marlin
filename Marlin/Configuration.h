...
#define STRING_CONFIG_H_AUTHOR "Emmanuel Lee" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro Direct Drive V1.5 (4.2.2)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -12.7, -2.627 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_Z_HOP       8.0        // (mm) Z height of nozzle between tramming points
